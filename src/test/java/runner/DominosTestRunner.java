...
@CucumberOptions(features = ".\\src\\test\\resources\\features", extraGlue = {
		"stepDefinations",}, plugin = {"pretty",
				...
				"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}, tags = "@AddTOCartTestSuite")

public class DominosTestRunner<CucumberFeatureWrapper> {
	...
	public void openBrowser() {
		...
		browserFactory.navigateToTheDominosUrl();
	}
